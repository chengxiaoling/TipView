...
protocol PopViewDelegate : class {
    func popViewDidDismiss(_ popView : PopView)
}

extension PopView {
    
    public class func show(animated: Bool = true, forView view: UIView, withinSuperview superview: UIView? = nil, text:  String, preferences: Preferences = PopView.globalPreferences, delegate: PopViewDelegate? = nil){
        
        let ev = PopView(text: text, preferences: preferences, delegate: delegate)
...
class PopView: UIView {
    ...
    fileprivate weak var delegate: PopViewDelegate?
    ...
    public init (text: String, preferences: Preferences = PopView.globalPreferences, delegate: PopViewDelegate? = nil){
